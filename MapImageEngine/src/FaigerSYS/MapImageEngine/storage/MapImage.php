...
class MapImage {
	 ...
	 * @return PacketBatch
	 */
	public function generateMapImagesPacketBatch() {
		$stream = new PacketBatch();
	 ...
	 * @return PacketBatch
	 */
	public function generateCustomMapImagesPacketBatch() {
		$stream = new PacketBatch();
		foreach ($this->chunks as $chunk) {
			$stream->putPacket($chunk->generateCustomMapImagePacket());
		}
		return $stream;
	}
